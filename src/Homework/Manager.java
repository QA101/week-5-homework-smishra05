 ...
 */
public class Manager extends Employee{ //Answer " Extended Employee class
	 ...
	 */
	public Manager(String name, int salary, int maxSize) { //added the params to make sure to initialize the variables getting passed
		this.name = name;
		this.salary = salary;
